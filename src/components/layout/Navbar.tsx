        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-18">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              {/* Cart */}
              <button className="btn-ghost p-2 rounded-xl relative" aria-label="Cart">
                <ShoppingCart className="w-5 h-5" />
                <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-primary-500 text-white text-2xs font-bold rounded-full flex items-center justify-center">
                  0
                </span>
              </button>
